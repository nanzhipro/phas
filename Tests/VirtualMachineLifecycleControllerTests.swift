...
final class VirtualMachineLifecycleControllerTests: XCTestCase {
    ...
    func testPreparingToStartInstallMediaMovesDraftToInstalling() throws {
        ...
        let updated = try controller.recordByPreparingToStart(record, at: Date(timeIntervalSince1970: 1_700_000_001))
    ...
    func testGuestStopAfterInstallSwitchesToDiskBoot() {
        ...
        let updated = controller.recordByHandlingGuestStop(record, at: Date(timeIntervalSince1970: 1_700_000_002))
    ...
    func testPreparingToStartInstalledVMMovesToRunning() throws {
        ...
        let updated = try controller.recordByPreparingToStart(record, at: Date(timeIntervalSince1970: 1_700_000_003))
    ...
    func testRuntimeFailureMovesToError() {
        ...
        let updated = controller.recordByHandlingRuntimeFailure(record, at: Date(timeIntervalSince1970: 1_700_000_004))
    ...
    func testNetworkDisconnectMovesToError() {
        ...
        let updated = controller.recordByHandlingNetworkDisconnect(record, at: Date(timeIntervalSince1970: 1_700_000_005))
