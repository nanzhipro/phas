                ...
                VStack(alignment: .leading, spacing: 20) {
                    ...
                    card(title: "Resources", systemImage: "slider.horizontal.3") {
                        VStack(alignment: .leading, spacing: 14) {
                            ...
                            Text("Light: 2/4/32. Standard: 4/8/64. Custom remains bounded by admission rules so the VM can still boot on the current host.")
                                .font(.footnote)
                                .foregroundStyle(.secondary)
                        }
                    }
                    ...
                    card(title: "Admission Report", systemImage: "exclamationmark.bubble") {
                        if report.issues.isEmpty {
                            Text("No blocking issues or warnings. This configuration can be created as a draft VM.")
                                .foregroundStyle(.secondary)
                        } else {
