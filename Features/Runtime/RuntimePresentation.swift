...
struct RuntimeControlAvailability: Equatable {
    ...
    static func make(record: VirtualMachineRecord?, capabilities: RuntimeMachineCapabilities?) -> RuntimeControlAvailability {
...
private extension VirtualMachineBootSource {
